...
modelfad4 <-  'FD =~ FD1 + FD5 + FD9 + FD13 + FD17
SD =~ SD2 + SD6 + SD10 + SD14 + SD18 + SD22 + SD24
UP =~ UP3 + UP7 + UP11 + UP15 + UP19 + UP20 + UP25 +UP27  
FW =~ FW4 + FW8 + FW12 + FW16 + FW21 + FW23 + FW26'


modelfad4test <-  'FD =~ FD1 + c(v1,v1)*FD5 + c(v1,v1)*FD9 +  FD13 +  c(v1,v1)*FD17
SD =~ SD2 + c(v1,v1)*SD6 + SD10 + SD14 +  c(v1,v1)*SD18 +  SD22 +  c(v1,v1)*SD24
UP =~ UP3 +  UP7 + c(v1,v1)* UP11 + c(v1,v1)*UP15 +  UP19 +  c(v1,v1)*UP20 +  c(v1,v1)*UP25 + c(v1,v1)*UP27  
FW =~ FW4 +  c(v1,v1)*FW8 +  FW12 +  c(v1,v1)*FW16 +  c(v1,v1)*FW21 +  c(v1,v1)*FW23 +  c(v1,v1)*FW26'


MI <- function(m1,m2,nombre,modelo){
  fadnames <- nombre
  model <-  modelo
  m1fad <- m1[,fadnames]
  m2fad <- m2[,fadnames]
...
CHN_ENG_model4 <- MI(fad2,fadA,fadnames,modelfad4)
CHN_ENG_modeltest <- MI(fad2,fadA,fadnames,modelfad4test)

FRN_ENG_model4 <- MI(fadF,fadA,fadnames,modelfad4)
FRN_ENG_modeltest <- MI(fadF,fadA,fadnames,modelfad4test)

JPN_ENG_model4 <- MI(fadJ,fadA,fadnames,modelfad4)
JPN_ENG_modeltest <- MI(fadJ,fadA,fadnames,modelfad4test)
